%% L1 = L2 = [1:collect:C2 2:collect:C2 for lazy A in 1..3 body {C1 A}{C1 A+1}{C2 yes}{C2 no}]
declare L1 L2 in
%% Big local
thread L2 =
   local
...
thread L1 =  [1:collect:C1 2:collect:C2 for lazy A in 1..3 body {C1 A}{C1 A+1}{C2 yes}{C2 no}] end
