%% L1 = L2 = [A+B for lazy A in 1 ; A<10 ; A+1 if A<4 for lazy B in 2*A ; B<20 ; B+2 if A+B>4]
declare L1 L2 in
%% Big local
thread L2 =
   local
...
thread L1 = [A+B for lazy A in 1 ; A<10 ; A+1 if A<4 for lazy B in 2*A ; B<20 ; B+2 if A+B>4] end
